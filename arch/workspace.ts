...
const admin = workspace.model.addPerson(
  "Admin",
  "administers the system and manages user"
)!;
...
const ingress = factory.addContainer(
  "ingress",
  "accepts incoming telemetry data",
  "IoT Hub"
)!;
const storage = factory.addContainer(
  "storage",
  "stores telemetry data",
  "Table Storage"
)!;
const frontend = factory.addContainer(
  "frontend",
